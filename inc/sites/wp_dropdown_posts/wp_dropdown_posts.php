<?php
/**
 * Plugin Name: wp_dropdown_posts
 * Plugin URI: https://github.com/tripflex/wp_dropdown_posts
 * Description: WordPress wp_dropdown_posts() function. Based off wp_dropdown_users() and wp_dropdown_pages() 
 * Author: tripflex
